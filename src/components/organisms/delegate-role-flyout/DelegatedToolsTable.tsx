...
import { getToolRolePermissionDetailsForDelegation } from '../../../services/delegation';
    ...
    const fetchPermissionDetails = async (
        ...
        try {
            ...
            const response: AppRolePermissionRowData =
                await getToolRolePermissionDetailsForDelegation({
                    roleId: roleIds,
                    toolID: toolIds,
                    pageSize,
                    pageNumber,
...
export default DelegatedToolsTable;
