...
import { fetchDelegatedRoleViewByDelegationNew } from '../../../store/thunks/fetchDelegatedRoleViewNew';
...
const DelegationRolePermissionFlyoutNew = ({ delegationId, open, onClose }: Props) => {
    const dispatch = useDispatch<AppDispatch>();
    const { data, loading } = useSelector((state: RootState) => state.delegationPermissionsNew);
    ...
    useEffect(() => {
        if (open && delegationId) {
            ...
            dispatch(
                fetchDelegatedRoleViewByDelegationNew({
                    delegationId,
                    pageNumber: safePage,
                    pageSize: safeSize,
                }),
...
export default DelegationRolePermissionFlyoutNew;
