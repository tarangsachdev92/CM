...
import { fetchDelegatedRoleViewNew } from '../../../store/thunks/fetchDelegatedRoleViewNew';
...
const DelegationPermissionsFlyoutNew = ({
  roleId,
  roleRegion,
  roleName,
  toggleFlyout,
  ...
  useEffect(() => {
    ...
    if (!roleId) return;
    dispatch(fetchDelegatedRoleViewNew({ roleId }));
...
export default DelegationPermissionsFlyoutNew;