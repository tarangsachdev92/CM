...
import { deleteDelegation } from '../../../services/delegation';
import DelegationRoleFlyout from '../delegate-role-flyout/DelegationRoleFlyout';
import DelegationRolePermissionFlyout from '../delegation-permission-flyout/DelegationRolePermissionFlyout';
...
export default function DelegationDataTable({
    delegationData,
    pageNumber,
    pageSize,
    totalRows,
    ...
    return (
        <>
            ...
            {selectedDelegationId && (
                <DelegationRolePermissionFlyout
