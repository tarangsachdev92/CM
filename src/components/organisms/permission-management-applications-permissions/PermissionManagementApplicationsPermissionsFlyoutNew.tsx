...
import { AppDispatch, RootState, fetchApplicationPermissionsForRoleV1 } from '../../../store';
import {
    deleteApplicationRoleMappingNew,
    submitApplicationRoleMappingNew,
...
const PermissionManagementApplicationsPermissionsFlyoutNew = ({
    toggleFlyout,
    roleDetails,
    ...
    const handleRemoveRow = async (key: number, type?: string) => {
        ...
        try {
            await deleteApplicationRoleMappingNew(payload);
    ...
    const onClickHandlerForSaveChanges = async () => {
        ...
        setButtonLoadingState(true);
        try {
            const response = await submitApplicationRoleMappingNew([
            ...
            logError(
                'PermissionManagementApplicationsPermissionsFlyout - onClickHandlerForSaveChanges - submitApplicationRoleMappingNew error',
                error,
            );
            setToggleErrorToast(true);
        } finally {
...
export default PermissionManagementApplicationsPermissionsFlyoutNew;
