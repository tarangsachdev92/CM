...
import { BlankColumnChart } from '../../../../assets/images/images';
...
const EmptyColumnChart = ({ onDelete, onEdit, state }: Props) => {
            ...
            {state === 'invalid' && (
                <>
                    <Flex vertical align="center" className={styles.labels}>
                        ...
                        <Label type="body3">
                            The selected parameters don’t return any data. Try adjusting your
                            selections to view the chart.
                        </Label>
                    </Flex>
                </>
            )}
...
export default EmptyColumnChart;
