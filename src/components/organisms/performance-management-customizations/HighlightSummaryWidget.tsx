...
const HighlightSummaryWidget = ({
    ...
    const persistedSummaryState = useSelector((state: RootState) =>
        activeTabId === undefined ? undefined : selectTabWidgetsState(state, activeTabId).highlightSummary,
    );
    ...
    const persistSummaryState = (nextSummaryState: HighlightSummaryState) => {
        ...
        dispatch(setHighlightSummaryState({ tabId: activeTabId, summary: nextSummaryState }));
            ...
            try {
                await dispatch(
                    saveTabWidgetsState({
                        ...
                        data: {
                            ...(currentTabState ?? {}),
                            highlightSummary: nextSummaryState,
    ...
    return (
        <>
            <div
                className={`${styles['highlight-summary-widget']} ${isPreviewMode ? styles['highlight-summary-widget--preview'] : ''} ${isSelected ? styles['highlight-summary-widget--selected'] : ''}`}
