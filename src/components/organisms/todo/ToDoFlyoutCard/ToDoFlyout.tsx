...
import FlyoutTaskDetails from './ToDoFlyoutTaskDetails';
import {
    setSelectedTools,
...
const ToDoFlyout: React.FC<Props> = ({ isOpen, setIsOpen, onFilterChange, externalSelectedId }) => {
