...
const delegationPermissionsSliceNew = createSlice({
  name: "delegationPermissionsNew",
  initialState,
  reducers: {
...
export const { resetDelegationPermissions } = delegationPermissionsSliceNew.actions;
export default delegationPermissionsSliceNew.reducer;