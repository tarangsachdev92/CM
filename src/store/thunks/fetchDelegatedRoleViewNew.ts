...
import { getDelegationPermissionsNew } from '../../services/delegationNew';
...
export const fetchDelegatedRoleViewNew = createAsyncThunk<
...
export const fetchDelegatedRoleViewByDelegationNew = createAsyncThunk(
  ...
  async (
    ...
    try {
      const res = await getDelegationPermissionsNew(delegationId, pageNumber, pageSize);
